...
plot_info = {
    ...
    'H-bonded': (
    GS.data_root_dir + 'mm_4hb/results/vee__2DES_12.dat',
    GS.data_root_dir + 'mm_4hb/results/vee__2DES_50.dat',
    GS.data_root_dir + 'mm_4hb/results/vee__2DES_100.dat'),

    'Pi Solvent': (
    GS.data_root_dir + 'mm_C4/results/vee__2DES_12.dat',
    GS.data_root_dir + 'mm_C4/results/vee__2DES_50.dat',
    GS.data_root_dir + 'mm_C4/results/vee__2DES_100.dat'),

    'QM1': (
    GS.data_root_dir + 'mm_qm1/results/vee__2DES_12.dat',
    GS.data_root_dir + 'mm_qm1/results/vee__2DES_50.dat',
    GS.data_root_dir + 'mm_qm1/results/vee__2DES_100.dat'),
